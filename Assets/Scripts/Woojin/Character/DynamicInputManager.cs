...
namespace DynamicController {
    ...
    {
        public static DynamicInputManager instance;

        private UserInputAssets _userInputAssets;
        public DynamicInputData dynamicInputData;

        public GameObject characterObject;
        // private ExampleCharacterController _characterController;
        // private DynamicCharaterInputs.CharacterInput _characterInput;
        ...
        private void Awake() {
            ...
            _dynamicCharacterController = characterObject.GetComponent<DynamicCharacterController>();
        ...
        private void OnJump(InputAction.CallbackContext c) {
            ...
            dynamicInputData.isJump = c.ReadValue<float>() == 1f; 
        }
